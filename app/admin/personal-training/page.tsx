    ...
    <div className="flex flex-col gap-6 p-6">
      ...
      <Tabs defaultValue="sessions" className="w-full">
        ...
        <TabsContent value="schedule" className="space-y-4 pt-4">
          {/* Shared with the nutritionist and sports-scientist pages — every
              expert type edits the same ExpertSchedule document. */}
          <ExpertAvailabilityEditor
            expertType="trainer"
            expertId={activeTrainerId}
            expertName={currentTrainer?.name || user?.name || 'My Schedule'}
            title={
              isTrainer
                ? 'My Weekly Schedule & Working Hours'
                : 'Trainer Weekly Schedule & Availability'
            }
            description="Configure working hours and split shifts. Session length and buffer are fixed at 45 and 15 minutes for personal training."
            headerAction={
              isTrainer ? undefined : (
                <select

export const queryKeys = {
  ...
  nutritionists: {
    myClients: () => ['nutritionists', 'me', 'clients'] as const,
    myClient: (userId: string) => ['nutritionists', 'me', 'clients', userId] as const,
  },
  slots: {
    all: () => ['slots'] as const,
  ...
  gymVisits: {
    all: (filters?: Record<string, unknown>) =>
      ['gym-visits', 'list', filters ?? {}] as const,
    currentlyIn: () => ['gym-visits', 'currently-in'] as const,
    mine: (limit?: number) => ['gym-visits', 'me', limit ?? null] as const,
    analytics: (range?: Record<string, unknown>) =>
      ['gym-visits', 'analytics', range ?? {}] as const,
  },
  exercises: {
  ...
  community: {
    ...
    posts: (filters?: Record<string, string>) => ['community', 'posts', filters ?? {}] as const,
    ...
    users: (filters?: Record<string, string>) => ['community', 'users', filters ?? {}] as const,

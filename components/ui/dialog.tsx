...
const DialogContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> & {
    /** Skip rendering the dim overlay — used to keep a dialog mounted but
     * visually "minimized" without blocking the page behind it. */
    hideOverlay?: boolean
  }
>(({ className, children, hideOverlay, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // w-[calc(100%-2rem)] keeps a 1rem gutter on phones; without it every
        // dialog renders edge-to-edge with its border flush against the screen.
